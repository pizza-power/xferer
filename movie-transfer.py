...
if __name__ == "__main__":
    ...
    while True:
        # should i put some of this in its own function
        selection = input(
            Fore.CYAN
        ...
        if selection == "l":
            ...
            # should i put this in its own functions
            try:
                # check for a duplicate entry, this fixes itself though
                # because the dictionary will just update itself
